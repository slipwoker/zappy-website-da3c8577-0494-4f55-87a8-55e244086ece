    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Sofnet Computer Networks LTD. uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'da3c8577-0494-4f55-87a8-55e244086ece',
                    name: data.name || '',
                    email: data.email || '',
